...
public class ThreeDES {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encodeMsg = threeDES.encryptDESCBC(telePhone, key);
        System.out.println("DES加密："+encodeMsg);

        String decodeMsg = threeDES.decryptDESCBC(encodeMsg, key);
        System.out.println("解密数据："+decodeMsg);
