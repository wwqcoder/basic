...
public class FileCompress {
    ...
    //要压缩的图片文件所在所存放位置
    public static String JPG_FILE_PATH = "C:\\Users\\super\\Desktop\\tools\\predixy-1.0.5-bin-amd64-linux.tar.gz";

    //zip压缩包所存放的位置
    public static String ZIP_FILE = "C:\\Users\\super\\Desktop\\minio.zip";
