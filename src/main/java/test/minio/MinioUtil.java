...
public class MinioUtil {
    ...
    public static void main(String[] args) throws Exception{
        File file = new File("C:\\Users\\super\\Desktop\\zje.jpg");
        InputStream in  = new FileInputStream(file);
        JSONObject upload = upload(in, "", ".jpg");
