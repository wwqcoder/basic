...
class LoggerBase {
    ...
    static {
        ACCESS_LOGGER = org.slf4j.LoggerFactory.getLogger(System.getProperty("logger.access.name", "ACCESS"));
        PERF_LOGGER = org.slf4j.LoggerFactory.getLogger(System.getProperty("logger.performance.name", "PERFORMANCE"));
    }
