...
public final class JsonUtil {
    ...
    private static String object2Json(final Object bean) {
        //数据检查
        if (bean == null) {
            return "{}";
        }
    ...
    public static Map json2Map(String jsonMapStr) {
        HashMap<String, String> map = (HashMap<String, String>) JSON.parseObject(jsonMapStr, HashMap.class);
        return map;
    }
    ...
    public static List<Map<String, Object>> jsonArray2List(String jsonArrayStr) {
        // 转换为：JSONObject数组形式
        JSONArray jsonArrays = JSON.parseArray(jsonArrayStr);
     ...
     * @return 转换后的列表   如果转换失败返回null
     */
    public static List<Map<String, Object>> jsonArray2List(JSONArray jsonArrays) {
        // 转换为：JSONObject数组形式
        List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
        for (Object obj : jsonArrays) {
            JSONObject jsonObject = (JSONObject) obj;
...
//
//        String textArray = "[{\"firstName\":\"bill\",\"lastName\":\"Gates\"}," +
//                "{\"firstName\":\"George\",\"lastName\":\"Bush\"}," +
//                "{\"firstName\":\"Thomas\",\"lastName\":\"Carte\"}]";
//        List<Map<String, Object>> list2 = jsonArray2List(textArray);
...
//        JsonUtil.map2Json(map);
        ...
        TestDto testDto = new TestDto();
        Object[] arr = new Object[]{testDto};
        testDto.setStrArr(arr);
...
class TestDto {
    ...
    public void setStrArr(Object[] strArr) {
        this.strArr = strArr;
    }
}
