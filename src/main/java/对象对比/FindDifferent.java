...
public class FindDifferent {
    ...
    public static void main(String[] args) {
        ...
        List<CompareResult> compareResults = findDiff(oldData, newData);
    ...
    public static <T> InvokeField findField(T initObject, String paraName) {
        ...
        for (Field field : allFields) {
            ...
            if (findField != null && paraName !=null && findField.getField() != null && paraName.equals(findField.getField().getName())){
                break;
            }
